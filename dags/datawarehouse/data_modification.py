    ...
    try:
        ...
        if schema == "staging":
            ...
            cur.execute(
                ...
                VALUES (%(id)s, %(title)s,%(publishedAt)s,%(duration)s,%(viewCount)s,%(likeCount)s,%(commentCount)s);
                """, row
...
def delete_rows(cur, conn, schema, ids_to_delete):
    ...
    try:
        ...
        logger.error(f"Error while trying to delete the video with ids: {ids_to_delete} - {e}")
        raise e